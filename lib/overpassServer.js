...
function waterQuery(around) {
  return `[out:json][timeout:60];(way(${around})[natural=water];way(${around})[natural=coastline];way(${around})[waterway=riverbank];way(${around})[waterway~"^(river|stream|canal)$"];);out geom 400;(relation(${around})[natural=water];relation(${around})[waterway=riverbank];relation(${around})[water];);out geom 120;`;
}
...
function combinedQuery(around) {
  return [
    ...
    `(way(${around})[natural=water];way(${around})[natural=coastline];way(${around})[waterway=riverbank];way(${around})[waterway~"^(river|stream|canal)$"];); out geom 400;`,
