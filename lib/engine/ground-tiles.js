...
export function isMapWaterRgb(r, g, b) {
  // Carto Voyager's open ocean is commonly 213/232/235; older OSM water is
  // more saturated (~170/211/223). Hue separation excludes white roads and
  // warm land while covering both palettes.
  return b >= 175 && g >= 155 && r <= 235 && b - r >= 12 && g - r >= 8;
}
